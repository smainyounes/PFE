...
<div class="accordion my-3" id="accordionExample">
  ...
  <div class="card crd">
              <div class="card-header" id="">
                <h5 class="mb-0">
                  <button class="btn btn-link collapsed bl-7" type="button" data-toggle="collapse" data-target="#collapsefd" aria-expanded="false" aria-controls="collapsefd">
                    Date d'expiration:<img src="img/up.png" class="pl-2">
                  </button>
                </h5>
              </div>
              <div id="collapsefd" class="collapse show" aria-labelledby="heading" >
                <div class="card-body">
                  <div class="form-group">
                   <input type="date" name="bday" id="datefield" max="3000-12-31" 
                          min="2019-01-01" class="form-control" required>
                  </div>
                </div>
              </div>
            </div>
  ...
  $( "#affichage" ).submit(function( event ) {
    ...
    if(fsize > 10000000)
    {
     ...
     //$("#ErrorImg").show();
      ...
      form_data.append("date",$("#datefield").val() );
